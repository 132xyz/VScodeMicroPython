...
from mpyrepl.completion.parser import (
    CompletionRequest,
...
class ReplCompleter(Completer):
    ...
    def _dotted_candidates(
        ...
        merge_runtime_candidates = (
            ...
            or self._session_symbols.has_runtime_root(request.expression)
        )
        if stub_candidates and not merge_runtime_candidates:
            return local_candidates

        if fallback_candidates and not merge_runtime_candidates:
