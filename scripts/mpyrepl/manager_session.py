...
from fs_ops import DeviceFsClient, FsOperationError, run_fs_operation
...
class ManagerSession:
    ...
    async def execute(self, source: str, follow_timeout: float | None = None) -> dict[str, str]:
